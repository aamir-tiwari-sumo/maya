...
import (
	...
	v1 "github.com/aamir-tiwari-sumo/maya/pkg/client/generated/openebs.io/snapshot/v1/lister/snapshot/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.VolumesnapshotV1().VolumeSnapshots(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VolumesnapshotV1().VolumeSnapshots(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *volumeSnapshotInformer) defaultInformer(client internalclientset.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *volumeSnapshotInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&snapshotv1.VolumeSnapshot{}, f.defaultInformer)
}
