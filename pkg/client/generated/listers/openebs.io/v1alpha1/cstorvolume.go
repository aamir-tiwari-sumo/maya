...
// List lists all CStorVolumes in the indexer.
func (s *cStorVolumeLister) List(selector labels.Selector) (ret []*v1alpha1.CStorVolume, err error) {
...
func (s cStorVolumeNamespaceLister) Get(name string) (*v1alpha1.CStorVolume, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("cstorvolume"), name)
	}
	return obj.(*v1alpha1.CStorVolume), nil
}
